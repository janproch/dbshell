...
namespace DbShell.Driver.Common.CommonDataLayer
{
    ...
    public class CdlRow : ICdlRecord
    {
        ...
        public bool GetBoolean()
        {
            ...
            throw new CdlTableError("DAE-00196 Cannot convert null to boolean");
        }
        ...
        public byte GetByte()
        {
            ...
            throw new CdlTableError("DAE-00197 Cannot convert null to byte");
        }
        ...
        public sbyte GetSByte()
        {
            ...
            throw new CdlTableError("DAE-00198 Cannot convert null to sbyte");
        }
        ...
        public byte[] GetByteArray()
        {
            ...
            throw new CdlTableError("DAE-00199 Cannot convert null to byte array");
        }
        ...
        public DateTime GetDateTime()
        {
            ...
            throw new CdlTableError("DAE-00200 Cannot convert null to datetime");
        }
        ...
        public DateTimeEx GetDateTimeEx()
        {
            ...
            throw new CdlTableError("DAE-00201 Cannot convert null to datetimeex");
        }
        ...
        public DateEx GetDateEx()
        {
            ...
            throw new CdlTableError("DAE-00202 Cannot convert null to dateex");
        }
        ...
        public TimeEx GetTimeEx()
        {
            ...
            throw new CdlTableError("DAE-00203 Cannot convert null to timeex");
        }
        ...
        public decimal GetDecimal()
        {
            ...
            throw new CdlTableError("DAE-00204 Cannot convert null to decimal");
        }
        ...
        public double GetDouble()
        {
            ...
            throw new CdlTableError("DAE-00205 Cannot convert null to double");
        }
        ...
        public float GetFloat()
        {
            ...
            throw new CdlTableError("DAE-00206 Cannot convert null to float");
        }
        ...
        public Guid GetGuid()
        {
            ...
            throw new CdlTableError("DAE-00207 Cannot convert null to Guid");
        }
        ...
        public short GetInt16()
        {
            ...
            throw new CdlTableError("DAE-00208 Cannot convert null to short");
        }
        ...
        public int GetInt32()
        {
            ...
            throw new CdlTableError("DAE-00209 Cannot convert null to int");
        }
        ...
        public long GetInt64()
        {
            ...
            throw new CdlTableError("DAE-00210 Cannot convert null to long");
        }
        ...
        public ushort GetUInt16()
        {
            ...
            throw new CdlTableError("DAE-00211 Cannot convert null to ushort");
        }
        ...
        public uint GetUInt32()
        {
            ...
            throw new CdlTableError("DAE-00212 Cannot convert null to uint");
        }
        ...
        public ulong GetUInt64()
        {
            ...
            throw new CdlTableError("DAE-00213 Cannot convert null to ulong");
        }
