                    ...
                    case 'f':
                        {
                            ...
                            if (num2 > 7)
                            {
                                throw new FormatException("DAE-00217 Bad format");
                            }
                    ...
                    case '\\':
                        {
                            ...
                            if (ch < 0)
                            {
                                throw new FormatException("DAE-00218 Invalid format");
                            }
        ...
        internal static int ParseQuoteString(string format, int pos, StringBuilder result)
        {
            ...
            while (pos < length)
            {
                ...
                if (ch2 == '\\')
                {
                    if (pos >= length)
                    {
                        throw new FormatException("DAE-00219 Invalid format");
                    }
            ...
            if (!flag)
            {
                throw new FormatException("DAE-00220 Format_BadQuote:" + ch);
            }
            return (pos - num2);
        }
