...
namespace DbShell.RelatedDataSync.SqlModel
{
    ...
    public class SqlScriptCompiler
    {
        ...
        public SqlScriptCompiler(IDatabaseFactory factory, DataSyncSqlModel datasync, IShellContext context, string procName)
        {
            ...
            PutMainTitleComment("This code is automatically generated by DbShell, do not edit", true);
        }
        ...
        public void PutMainTitleComment(string msg, bool spaceAfter = false)
        {
            if (!spaceAfter) _dmp.Put("&n");
            PutSeparator();
            _dmp.Put("-- %s &n", msg);
            PutSeparator();
            _dmp.Put("&n");
